	...
	if (isset($_POST['enviar'])){	
		...
		if (isset($_POST['codigo']) && $_POST['codigo'] != ""){
				...
				while($array = mysql_fetch_array($query)){
					...
					$_SESSION['preco_editar'] = $array['preço'];
				  ...
				  <td width="100%">
								...
								<td   style="background-color:#edfaff;">
									...
									<h1><center>Editar Produto</center></h1>
													...
													<center><table>
															<tr>
															<td>Código do Produto:</td><td><font color="#FF0000">*</font> <input type="text" name="codigo_consulta" id="codigo_consulta" size="30" value="<?php if(isset($_SESSION['codProduto_editar'])) echo $_SESSION['codProduto_editar']; ?>" onkeypress="return numeros(event.keyCode, event.which);"/><br></td>
															</tr>
															<tr>
															...
															<tr>
															<td>Preço:</td><td><font color="#FF0000">*</font> <input type="text" name="preco_consulta" id="preco_consulta" size="30" value="<?php if(isset($_SESSION['preco_editar'])) echo $_SESSION['preco_editar']; ?>" onkeypress="return numeros(event.keyCode, event.which);"/><br></td>
															</tr>
															<tr>
