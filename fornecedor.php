				...
				<tr> 
				  <td width="100%">
								...
								<tr>
									...
									<h1><center>Menu para Manter Fornecedor</center></h1>
									A tabela abaixo, lista os Fornecedores cadastrados no sistema.
										 ...
										 $result = mysql_query($sql);
												...
												echo 
												 ...
												 while($row = mysql_fetch_array($result))
												 {
													 ...
													 echo "<td><a href='editarFornecedor.php?tipo=user&acao=edit&id=".$row['codUsuario']."'>Editar</a> <a href='excluirFornecedor.php?tipo=user&acao=deletar&id=".$row['codUsuario']."'>Excluir</a></td>";
													 echo "</tr>";
												 }
												 echo "</table>";
									...
									<br>
									<input type="submit" value="Cadastrar Novo Fornecedor" onclick="location.href= 'cadastrarFornecedor.php' ">
									<br><br>									
									</td>
								</tr>
								</table>
