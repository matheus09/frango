...
include("conectar.php");
	...
	if (isset($_POST['enviar'])){	
		...
		if (isset($_POST['cpf']) && $_POST['cpf'] != ""){
				...
				$query = mysql_query("SELECT * FROM cliente WHERE cpf LIKE '".$cpf."%'") or die(mysql_error());
									
				while($array = mysql_fetch_array($query)){
					
					$_SESSION['nome_editar'] = $array['nome'];
					$_SESSION['cpf_editar'] = $array['cpf'];
					$_SESSION['dataNasc_editar'] = $array['dataNascimento'];
						$d=explode("-",$_SESSION['dataNasc_editar']);
						$_SESSION['dataNasc_editar'] = $d[2]."/".$d[1]."/".$d[0];
					$_SESSION['endereco_editar'] = $array['endereco'];
					$_SESSION['telefone_editar'] = $array['telefone'];
				}
				  ...
				  <td width="100%">
								...
								<td   style="background-color:#edfaff;">
									...
									<h1><center>Editar Cliente</center></h1>
													...
													<br>
													<form id="form2" name="form2" method="post" action="editarCliente2.php">
													Dados a Serem Editados:
													<hr color="#333333" size="1px" style="margin-bottom:2px; margin-top:2px;" /><br>
													<center><table>
															<tr>
															<td>Nome do Cliente:</td><td><font color="#FF0000">*</font> <input type="text" name="nome_consulta" id="nome_consulta" size="30" value="<?php if(isset($_SESSION['nome_editar'])) echo $_SESSION['nome_editar']; ?>" /><br></td>
															</tr>
															<tr>
															<td>CPF:</td><td><font color="#FF0000">*</font> <input type="text" name="cpf_consulta" id="cpf_consulta" size="30" value="<?php if(isset($_SESSION['cpf_editar'])) echo $_SESSION['cpf_editar']; ?>" onblur="javascript: validarCPF(this,this.value);" onkeypress="javascript: mascaraCPF(this, cpf_mask);"/><br></td>
															</tr>
															<tr>
															<td>Data de Nascimento:</td><td><font color="#FF0000">*</font> <input type="text" name="data_consulta" id="data_consulta" size="30" value="<?php if(isset($_SESSION['dataNasc_editar'])) echo $_SESSION['dataNasc_editar']; ?>" onkeyup="Formatadata(this,event)" onblur="VerificaData(this,this.value)" onkeypress="return numeros(event.keyCode, event.which);"/><br></td>
															</tr>
															<tr>
															<td>Endereco:</td><td><font color="#FF0000">*</font> <input type="text" name="endereco_consulta" id="endereco_consulta" size="30" value="<?php if(isset($_SESSION['endereco_editar'])) echo $_SESSION['endereco_editar']; ?>" onblur="checarEmail(this);"/><br></td>
															</tr>
															<tr>
															<td>Telefone:</td><td><font color="#FF0000">*</font> <input type="text" name="telefone_consulta" id="telefone_consulta" size="30" value="<?php if(isset($_SESSION['telefone_editar'])) echo $_SESSION['telefone_editar']; ?>" /><br></td>
															</tr>
													</center></table>
													<center><table>
															<tr>
															<td><input type="submit" name="enviar" value="Confirmar Edição"/></td>
															<td><input type="Reset" name="apagar" value="Apagar tudo"></td>
															</tr>
														</table></center>
													</form>
													<br>		
...
<?php
	...
	$_SESSION['nome_editar'] = "";
	$_SESSION['cpf_editar'] = "";
	$_SESSION['dataNasc_editar'] = "";
	$_SESSION['endereco_editar'] = "";
	$_SESSION['telefone_editar'] = "";
