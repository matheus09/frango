	...
	if (isset($_POST['enviar'])){	
		...
		if (isset($_POST['cpf']) && $_POST['cpf'] != ""){
				...
				while($array = mysql_fetch_array($query)){
					...
					$_SESSION['dataNasc_excluir'] = $array['dataNascimento'];
				  ...
				  <td width="100%">
								...
								<td   style="background-color:#edfaff;">
									...
									<h1><center>Excluir Cliente</center></h1>
													...
													<center><table>
															<tr>
															<td>Nome do Cliente:</td><td><font color="#FF0000">*</font> <input type="text" name="nome_consulta" id="nome_consulta" size="30" value="<?php if(isset($_SESSION['nome_excluir'])) echo $_SESSION['nome_excluir']; ?>" readonly="readonly"/><br></td>
															</tr>
															<tr>
															<td>CPF:</td><td><font color="#FF0000">*</font> <input type="text" name="cpf_consulta" id="cpf_consulta" size="30" value="<?php if(isset($_SESSION['cpf_excluir'])) echo $_SESSION['cpf_excluir']; ?>" onblur="javascript: validarCPF(this,this.value);" onkeypress="javascript: mascaraCPF(this, cpf_mask);" readonly="readonly"/><br></td>
															</tr>
															<tr>
															<td>Data de Nascimento:</td><td><font color="#FF0000">*</font> <input type="text" name="data_consulta" id="data_consulta" size="30" value="<?php if(isset($_SESSION['dataNasc_excluir'])) echo $_SESSION['dataNasc_excluir']; ?>" onkeyup="Formatadata(this,event)" onblur="VerificaData(this,this.value)" onkeypress="return numeros(event.keyCode, event.which);" readonly="readonly"/><br></td>
															</tr>
															<tr>
															<td>Endereco:</td><td><font color="#FF0000">*</font> <input type="text" name="endereco_consulta" id="endereco_consulta" size="30" value="<?php if(isset($_SESSION['endereco_excluir'])) echo $_SESSION['endereco_excluir']; ?>" onblur="checarEmail(this);" readonly="readonly"/><br></td>
															</tr>
															<tr>
															<td>Telefone:</td><td><font color="#FF0000">*</font> <input type="text" name="telefone_consulta" id="telefone_consulta" size="30" value="<?php if(isset($_SESSION['telefone_excluir'])) echo $_SESSION['telefone_excluir']; ?>" readonly="readonly"/><br></td>
															</tr>
													</center></table>
													<center><table>
															<tr>
