				  ...
				  <td width="100%">
								...
								<td   style="background-color:#edfaff;">
									<table width="548"  border="0" cellspacing="0" >
											...
											<p  class="justify">O SISGEFRAN Online proporciona ao Administrador nesta página as funcionalidades de manter outro Administrador, manter Funcionário, manter Fornecedor, além de todas as outras funcionalidades destinadas ao Funcionário. </p>																	
											<br/>
											...
											<a href= "telaInicial.php" style="text-decoration:none"><img src="images/telaAdministrador/trocar.png" height="50" width="50" border="0"/>Tela Inicial Funcinário</a>
											</div>
											</td>
											</tr>
									</table>
