	...
	if (isset($_POST['enviar'])){	
		...
		if (isset($_POST['cpf']) && $_POST['cpf'] != ""){
				...
				while($array = mysql_fetch_array($query)){
					...
					$_SESSION['dataNasc'] = $array['dataNascimento'];
						$d=explode("-",$dataNasc);
						$dataNasc=$d[2]."/".$d[1]."/".$d[0];
				...
				<tr> 
				  <td width="100%">
								...
								<td   style="background-color:#edfaff;">
									...
									<h1><center>Consultar Cliente</center></h1>
													...
													<center><br><div style="border: 1px solid black; overflow: scroll; width: 400px; height: 150px;">
														<?php
														 ...
														 echo "<td>" . $_SESSION['dataNasc'] . "</td>";
														 echo "<td>" . $_SESSION['endereco'] . "</td>";
